            ...
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <div class="row border-top mt-3 py-3">
                        <div class="col-sm-2">
                            <img src="<?php echo $item['item_image']?>" style="height: 120px;" alt="" srcset="" class="img-fluid">
                        </div>
                        <div class="col-sm-8">
                 ...
                 <div class="col-sm-3">
                    <div class="sub-total border text-center mt-2">
                        ...
                        <div class="border-top py-4">
                            <h5 class="font-baloo font-size-20">Subtotal (<?php echo isset($subTotal) ? count($subTotal) : 0; ?> items):&nbsp; <span class="text-danger">$<span class="text-danger" id="deal-price"></span><?php echo isset($subTotal) ? $Cart->getSum($subTotal) : 0; ?></span> </h5>
