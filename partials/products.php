        ...
        <div class="row">
          ...
          <div class="col-sm-6 py-5">
            ...
            <table class="my-3">
              ...
              <tr class="font-rale font-size-14">
                  <td>Deal Price:</td>
                  <td class="font-size-20 text-danger">$<span>150</span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
              </tr>
              <tr class="font-rale font-size-14">
                  <td>You Save:</td>
            ...
            <!-- product qty section -->  
              <div class="qty d-flex">
                  ...
                  <div class="px-4 d-flex font-rale">
                      <button class="qty-up border bg-light" data-id="pro-main"><i class="fas fa-angle-up"></i></button>
                      <input type="text" data-id="pro-main" class="qty_input border px-2 w-50 bg-light" disabled value="1" placeholder="1">
                      <button data-id="pro-main" class="qty-down border bg-light"><i class="fas fa-angle-down"></i></button>
                  </div>
              </div>
             <!-- !product qty section -->  
          </div>
